...
## The offer copy (v1.0, verbatim as sent)
...
- weekly 2-hour hands-on business building sessions
- check-ins through chat between sessions
- one clear expected result per week

**Price**

This container is the direct continuation of the Productize Yourself Session. It's designed as a cohort program; until the group assembles, it runs one-on-one: private strategic advisory at the cohort seat price: **$1,111** (or 2x $600). One-on-one means we go exactly at the client's pace.
...
1. **Vector, not self:** the promise is one direction chosen and sold, not more self-knowledge.
2. **Being-wanted register (Step 0.5):** timing facts stated plainly (cohort cadence), price held, no apology, no luring anchors.
3. **Stage-matched money door:** price integrity kept; payment split (2x $600) offered as cash-flow shape for survival-stage buyers, never a discount.
4. **One result per week:** each week ends in something the client can hold.
5. **No overpromise:** "first clients: free, paid, or a mix" — the honest floor, not the dream ceiling.
