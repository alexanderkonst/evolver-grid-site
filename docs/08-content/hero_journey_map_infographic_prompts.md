...
**What this is:** the lead-magnet map. 9 slides: cover, 7 chapters, CTA. Posted as a carousel (Instagram first, then everywhere). Acquisition funnel: map → "find where you are" → findyourtoptalent.com. Inside the product, the quiz precedes the full map so the person's answers are not primed by the framework; the result then locates them inside the larger journey.

**Core idea:** mythical descriptions leave the hero's journey ethereal. This map lands it in ordinary professional life in 2026: from archetypal to concrete, from high level to eye level. It shows what each chapter looks and feels like for a modern person earning, learning, building, stalling, breaking down, re-forming, and beginning again.

**Universality:** this is a universal recurring sequence: fit → outgrowing → misfit → rupture → the in-between → new identity → embodiment. People may move backward, and after embodiment the cycle begins again at a new level, but the seven chapters preserve their order. Like seven colors, they form one spectrum of professional development.

**Canon:** the copy below is Sasha's recorded source text for this carousel. Preserve it unless Sasha explicitly approves an edited poster cut. The 7-dot progress arc is the visual through-line: every chapter slide shows it with that chapter's dot lit.
...
be rendered exactly as specified, nothing added. No stock imagery, no
clip art.
```
...
## Slide 6 — Chapter 5: The Free Fall
...
```
CTA SLIDE.
Center, serif: "Free Quiz: Which chapter are you in?"
Below: "Find your chapter · About 2 minutes."
...
## Rules for the copy (if the agent adjusts anything)

- «Пиши, сокращай» discipline: cut every word that can be cut.
- No em-dashes. No exclamation marks. No promises.
- Chapter names and one-liners are canon; markers may be shortened, never lengthened.
- RU/ES versions later, from the quiz locale files, same structure.
