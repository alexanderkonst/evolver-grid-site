...
**Phase 3 kickoff notes:** Added a minimal growth path steps scaffold in `src/modules/growth-paths/index.ts`, mapped it to unified actions, and introduced a progress-based selector for Daily Loop v2.
