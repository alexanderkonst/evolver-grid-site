...
#### Module: Daily Loop (My Next Move)
...
### 👥 TEAMS SPACE (Discover)

#### Module: Matchmaking

| Field | Value |
|-------|-------|
| Master Result | Alone → Matched with my people (by genius, resources, mission) |
| Start | `/matchmaking` |
...
| Space | Count | Modules |
|-------|-------|---------|
| Profile | 5 | ZoG, QoL, Personality Tests, Mission, Resources |
...
## 🗺️ Onboarding Modules (Special)

| Module | Master Result |
|--------|---------------|
| **Onboarding Entry** | Stranger → System knows who I am |
| **Tour** | Lost → Know exactly where to start |

*These modules span the platform, introducing users to all Spaces.*
...
*Module Taxonomy v1.2 — Organized by Spaces*
