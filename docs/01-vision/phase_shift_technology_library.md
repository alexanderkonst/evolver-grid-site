...
**Relationship:** Pain Theory Playbook (The Recursive Shadow of Pain), Technology 130 (the mirror pays in the shadow's currency), Sacred Transaction Field (Emotional Recognition lever), the deep Top Talent reveal spec (implementation target).
