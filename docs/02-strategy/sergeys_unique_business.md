...
*Version: v0.1 · March 10, 2026 — initial draft*

**Who resonates (hypothesis):**

Leaders, founders, and builders drowning in complexity — simultaneously running strategy, product, ops, and people — who sense there's a simpler pattern underneath but can't see it from inside. They've tried frameworks. They've tried consultants. They've tried "getting organized." Nothing sticks because the solutions are generic and their problem is unique.

**Draft qualifiers:**
1. **Complexity-drowning** — too many moving parts, no clear operating structure
2. **Analytically gifted** — smart enough to see the problem, not positioned to see their own pattern
3. **AI-curious or AI-active** — they sense AI could transform their work but haven't found the bridge
4. **Mission-driven** — they care about human development, not just efficiency
5. **Want a system, not a consultant** — they want to learn to fish, not be fed

**Named people:** TBD — to be identified in session

---

### 4. Pain (Point A)

*Version: v0.1 · March 10, 2026 — initial from Two-Question Seed*

**Surface:** Financial pressure. Cash gap. Needs monthly income. Willing to compromise on projects that aren't fully aligned.

**Underneath (hypothesis):** 2-3 years of pivots. Each strategy "almost works." Sber project, AI experiments, B2B explorations — all moving, none landing. The debts grow. The cash gap widens. October onwards: chaos in personal finances. Borrowing from friends to cover credit card. The "light at the end of the tunnel" keeps moving.

**The structural issue:** He builds systems for OTHER people beautifully. But he hasn't built THE system for himself — the one that turns his specific genius into a specific product with specific clients paying specific money. He keeps solving generic problems for generic clients instead of solving HIS problem for HIS tribe.

---

### 5. Promise (Point B)

*Version: v0.0 · March 10, 2026 — placeholder*

**One sentence (draft):**

> From building everyone else's systems to building THE system — the one that only you can build, for the people only you can serve, generating income from your specific genius.
