...
### Who you're actually broadcasting to

The aligned tribe is **conscious aspiring impact founders** — articulated at 9.9/10 precision in Sasha's master tuning forks (per [`alexanders_unique_business.md`](../02-strategy/unique-businesses/alexanders_unique_business.md) and the Tuning Fork section). The Productize Yourself / Top Talent Business Session is precisely engineered for someone who has a *talent / calling + no business yet* (or an early venture seeking integration). Adjacent segments exist (consultants with frameworks, established coaches, etc.) but they need a *different product* — not the current value ladder. **Don't dilute the aligned tribe by chasing adjacent ones.** The attraction-mode principle from `marketing_playbook.md` is explicit: *"Ads dilute the aligned tribe — once mixed, hard to un-mix."* The same principle applies to outreach segments.

The conscious aspiring impact founder shows up under multiple vocabularies — different self-descriptions, same psychographic:

- *"Conscious entrepreneur"* / *"conscious entrepreneurship"*
- *"Purpose-driven founder"* / *"purpose-driven business"*
- *"Soul-aligned business"* / *"soul-aligned founder"*
- *"Impact founder"*
- *"Regenerative entrepreneur"* / *"regenerative business"*
- *"Integral business"* / *"integral founder"*
- *"Spiritual entrepreneur"* / *"mission-driven founder"*

These are the same person framed through different vocabularies. Search across all of them; don't pick just one.

### LinkedIn outreach — the operational pattern

LinkedIn is the highest-leverage channel because the conscious-impact-founder tribe congregates there to articulate their work + find resonance with others doing similar work.

#### Search keywords (paste into LinkedIn search)

```
"conscious entrepreneur" founder
"impact founder"
"purpose-driven" founder
"soul-aligned" business
"regenerative entrepreneur"
"integral business" OR "integral founder"
"mission-driven founder"
```

#### Hashtag feeds to scan
...
#### Quality signals when on a profile (high-fit)

- Posts about consciousness + business integration (not just one or the other)
- Uses integral / holistic / depth-work vocabulary alongside business terms
- Often early in their venture (1–3 years in)
- Visible signs of self-development orientation (workshops, retreats, integral framework references)
- Mid-career professional pivoting toward purpose work
- Real engagement on posts (not vanity metrics)
- May reference Wilber, integral, somatic, holistic, regenerative, conscious capitalism

#### Anti-signals (skip)

- Pure spiritual content with no business-building signal (won't pay for productization)
- Pure business content with no integration / consciousness signal (not the tribe — adjacent at most)
- Established 7-figure operators (not aspiring; already there)
- Pure life coaches with no founder-orientation
- Generic "consultant" without consciousness-integration signal — different product needed

#### The 4-week ramp

- **Week 1:** ~10 hand-crafted DMs/day to founders whose work you've engaged with (read a post, looked at their venture, can reference something specific in their consciousness-business integration)
...
- **Week 4:** evaluate — what % responded? what % booked? which sub-vocabulary (conscious / impact / regenerative / integral) responded most? Adjust for week 5+ based on real signal.
...
See `communications_playbook.md` — *Attraction-Mode DM Template* — for the copy structure. The structural elements:

1. **Mirror first** — specific reference to their work (NOT generic compliment)
2. **Name the structural insight** they may not have articulated (e.g., the talent-to-business gap, the integration-of-self-and-work gap)
...
Once an aligned founder responds positively, the onboarding ramp:
...
5. Long-arc: graduates of cohort + advisory tier become **IFC members** — co-creators, distributors, network nodes in the Impact Founder Collective
...
- ❌ Confusing reach (lots of DMs) with resonance (right DMs to the right tribe vocabulary)
- ❌ **Chasing adjacent segments (consultants with frameworks, established coaches) for "immediacy" — different product, different page, different vocabulary needed. Don't dilute the aligned tribe.** This was a real trap caught + corrected on Day 54+: AI proposed "consultants with frameworks" as a high-immediacy segment, Sasha pushed back, the segmentation was corrected to honor the actual stated tribe. Lesson logged.

---

*Updated: April 28, 2026 (Day 54+) — Impact Founder Collective Distribution section added to operationalize UBP §16 (The Self-Monetizing Founder). Specifies the aligned-tribe-vocabulary-set (conscious / impact / purpose-driven / soul-aligned / regenerative / integral / mission-driven — same psychographic, multiple self-descriptions), the LinkedIn search + quality + anti-signals, the 4-week outreach ramp, the onboarding ramp from first DM to IFC member, and the explicit anti-pattern of chasing adjacent segments (consultants with frameworks) for "immediacy" — that trap was caught + corrected this session. Cross-references `communications_playbook.md` (DM template) and `marketing_playbook.md` (attraction-mode mechanics).*
