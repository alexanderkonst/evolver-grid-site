# Distribution Playbook (Archived, pre-v2.0, July 22 2026)

> *Archived Day 132 (July 22, 2026) when `docs/03-playbooks/distribution_playbook.md` was restructured to v2.0 per the Jobs triad (product · marketing · distribution, sales folded in as Part B). This file preserves the full Parts I-VIII content (philosophy, execution workflow, realistic projections, AI-native infrastructure, the Sales organizing principle P×M×D×S=ONE, and the operational launch kit) verbatim for genealogy. The live v2.0 file holds durable channel doctrine + pointers instead; campaign execution now lives in `outreach_ops.md`, strategy in `outreach_strategy_2026-07.md`.*
