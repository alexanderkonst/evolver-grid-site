...
| **Commercial use of code or methodology** | [Stewarding Agreement](./DISTRIBUTOR_AGREEMENT.md) | Path A (subscribe) or Path B (fork + rev-share). Does NOT apply to the AI OS scaffold — see §2. |
...
- **NonCommercial** — You may not use the material for commercial purposes without explicit permission from the author. Two paths to permitted commercial use:
  ...
  2. **Fork and self-host** under the [Stewarding Agreement](./DISTRIBUTOR_AGREEMENT.md) — 10% rev-share above the $1,000/month free tier.
