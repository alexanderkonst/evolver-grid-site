    ...
    return (
        <div className="py-8">
            ...
            <div className="text-center mb-8">
                ...
                <h1 className="text-3xl font-bold text-slate-800 mb-2">Call to Action</h1>
                    ...
                    >
                        <CardContent className="p-6 text-center">
                            <div className={cn(
                                ...
                                selectedType === option.type ? "bg-primary text-slate-800-foreground" : "bg-muted"
                            )}>
                                <option.icon className="w-6 h-6" />
                            </div>
                            <h3 className="font-semibold text-slate-800 mb-2">{option.title}</h3>
                            <p className="text-sm text-slate-800 mb-4">{option.description}</p>
                            <div className={cn(
                                "inline-block px-4 py-2 rounded-lg text-sm font-medium",
                                selectedType === option.type
                                    ? "bg-primary text-slate-800-foreground"
