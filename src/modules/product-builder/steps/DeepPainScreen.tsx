    ...
    return (
        <div className="py-8">
            ...
            <div className="text-center mb-8">
                ...
                <h1 className="text-3xl font-bold text-[#2c3150] mb-2">Their Pain</h1>
                        ...
                        <CardContent className="p-0">
                            <div className="flex items-start gap-4 p-4">
                                ...
                                <div className="flex-1">
                                    <h3 className="font-semibold text-[#2c3150]">{section.title}</h3>
                                    <p className="text-xs text-[#2c3150] mb-2">{section.subtitle}</p>
