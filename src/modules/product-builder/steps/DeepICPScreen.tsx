...
const DeepICPScreen: React.FC = () => {
    ...
    return (
        <div className="py-8">
            ...
            {/* ICP Card */}
            <Card className="mb-8 max-w-2xl mx-auto bg-[var(--skin-card-fill,#ffffff)] border border-[var(--skin-card-border,#e5e7eb)]">
                <CardContent className="p-6 space-y-6">
                    <div>
                        <h3 className="text-sm font-semibold text-primary-wabi uppercase tracking-wide mb-2">
                            Who They Are
                        </h3>
                        <p className="text-primary-wabi leading-relaxed">{state.deepICP?.who}</p>
                    </div>
                    ...
                    <div>
                        ...
                        <p className="text-primary-wabi leading-relaxed">{state.deepICP?.struggles}</p>
                    </div>
                    ...
                    <div>
                        ...
                        <p className="text-primary-wabi leading-relaxed">{state.deepICP?.desires}</p>
                    </div>
                </CardContent>
            </Card>
