...
const ARCHETYPES: Record<ArchetypeId, ArchetypeResult> = {
  invisible_genius: {
    ...
    blade: "Most people stop here. They understand themselves better… but nothing actually changes.",
  ...
  multi_talent_trap: {
    ...
    blade: "Most people stay in motion—without direction.",
    cta: "Watch how this becomes something real",
    ctaSub: "See what actually resolves the scatter pattern",
  },
  misaligned_vector: {
    ...
    blade: "Most people keep pushing—without correcting direction.",
    cta: "Watch where this actually breaks",
    ctaSub: "See why effort alone doesn't produce results",
  },
  underpriced_operator: {
    ...
    blade: "Most people stay stuck here—knowing they should charge more, but not knowing how.",
    cta: "Watch how this shifts",
    ctaSub: "See what changes when people finally understand your value",
  },
};
