...
const ARCHETYPES: Record<ArchetypeId, ArchetypeResult> = {
  ...
  multi_talent_trap: {
    ...
    blade: "You've tried picking one thing. It never held all of you.",
  ...
  misaligned_vector: {
    ...
    blade: "You already know effort isn't the issue. But you keep applying it anyway.",
  ...
  underpriced_operator: {
    ...
    blade: "You've known you should charge more for years. Knowing didn't help.",
