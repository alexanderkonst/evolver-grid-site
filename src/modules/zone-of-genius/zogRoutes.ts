...
export const getZogAssessmentSteps = (basePath: string) => [
  { number: 1, label: "Quick Scan – Swipe Talents", path: `${basePath}/step-0` },
  { number: 2, label: "Choose Your Top 10 Talents", path: `${basePath}/step-1` },
  { number: 3, label: "Choose Your Top 3 Core Talents", path: `${basePath}/step-2` },
  { number: 4, label: "Order Your Top 3", path: `${basePath}/step-3` },
  { number: 5, label: "Your Zone of Genius Snapshot", path: `${basePath}/step-4` },
];
