  ...
  return (
    <div className="space-y-6" style={{ color: "var(--skin-text-primary, #0a1628)" }}>
      ...
      <div className="sticky top-4 z-10">
        <div
          className="liquid-glass flex items-center justify-between px-5 py-3 rounded-xl transition-all duration-300"
        >
      ...
      {/* Talent Grid — Apple Liquid Glass cards */}
      ...
      {/* Mobile sticky bottom — Day 91 (Sasha 2026-06-09): white wash
          tokenized for Aurum; lapis keeps the exact gradient via fallback. */}
      <div
