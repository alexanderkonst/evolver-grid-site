...
export type Skin = "aurora" | "navy-gold" | "network-school" | "karime" | "daouniverse" | "planetir";
...
const VALID_SKINS: Skin[] = ["aurora", "navy-gold", "network-school", "karime", "daouniverse", "planetir"];
