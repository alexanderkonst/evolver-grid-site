...
- SECOND-PERSON VOICE: write every field in this JSON in SECOND-PERSON, addressing me directly as "you / your". NEVER use "I, me, my" (first person) or "they, their, them" (third person, when referring to ME — the subject). The output reads like an editorial observer speaking to me directly, naming what is structurally true about me. Example WRONG (first): "My gift generates its inverse — my own value stays invisible to me." Example WRONG (third): "Their gift generates its inverse — their own value stays invisible to them." Example RIGHT (second): "Your gift, making the invisible visible, comes paired with a shadow — your own value tends to stay invisible to you."
