...

{
  ...
  "shadow_currency": "ONE short paragraph (3-4 sentences) naming the hidden CURRENCY my shadow makes me over-give my gift to obtain — the non-money payment I unconsciously accept instead of real value, which is why the gift leaks out for free for years. Structure: (a) name the feeling I secretly get paid in (recognition from people who see my depth / certainty / intimacy and closeness / the completion of a finished thing / being needed) — pick the one that fits MY specific gift and shadow, not a generic list; (b) describe phenomenologically how the exchange feels in the moment ('you leave the conversation full, seen, and forget you were never paid'); (c) name the cost ('you leave less lonely instead of paid,' 'you buy your own certainty by giving the answer away'). SECOND-PERSON addressing me ('you / your'); other people stay 'they / them.' This is the single biggest energy leak — write it so I recognize exactly where my gift drains out. Plain words, no jargon, do not moralize.",
