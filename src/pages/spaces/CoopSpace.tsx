            ...
            <div className="p-6 lg:p-8 max-w-4xl mx-auto">
                ...
                <div className="mb-8">
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <h1 className="text-2xl font-bold text-slate-900">Venture Co-op Space</h1>
                    </div>
                ...
                <div className="rounded-xl border-2 border-dashed border-slate-300 bg-slate-50 p-12 text-center">
                    ...
                    <p className="text-slate-500 max-w-md mx-auto">
                        The Venture Co-op will enable you to join collective ventures, contribute your genius,
