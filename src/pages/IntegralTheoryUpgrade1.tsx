    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          ...
          { type: 'grid12', items: [
            { n: 1, q: "UL", text: "Does this feel TRUE from the inside?" },
          ...
          { type: 'grid12', items: [
            { n: 5, q: "UL", text: "Does this liberate or constrain the individual?" },
          ...
          { type: 'grid12', items: [
            { n: 9, q: "UL", text: "What must be done INTERNALLY next? What inner move is required?" },
      ...
      },
      {
        ...
        content: [
          ...
          { type: 'callout', text: "The Merkaba — the Star Tetrahedron — is formed here: two interpenetrating tetrahedra (the first act of seeing and the seeing of that seeing, offset by sequence), with the two Logoi (13 + 13) held in dynamic equilibrium. The 26-perspective seeing IS the Merkaba in full rotation." },
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          ...
          { type: 'grid12', items: [
            { n: 1, q: "ВЛ", text: "Чувствуется ли это ИСТИННЫМ изнутри?" },
          ...
          { type: 'grid12', items: [
            { n: 5, q: "ВЛ", text: "Освобождает это личность или ограничивает?" },
          ...
          { type: 'grid12', items: [
            { n: 9, q: "ВЛ", text: "Что должно быть сделано ВНУТРИ дальше? Какой внутренний шаг требуется?" },
      ...
      },
      {
        ...
        content: [
          ...
          { type: 'callout', text: "Меркаба — Звёздный Тетраэдр — формируется именно здесь: два взаимопроникающих тетраэдра (первый акт видения и видение этого видения, смещённые последовательностью), с двумя Логосами (13 + 13) в динамическом равновесии. 26-перспективное видение И ЕСТЬ Меркаба в полном вращении." },
