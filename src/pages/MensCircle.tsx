      ...
      <section className="py-20 px-6">
        <div className="max-w-3xl mx-auto text-center space-y-6">
          ...
          <p className="text-lg md:text-xl leading-relaxed opacity-90">
            <BionicText>
              Это пространство для русскоязычных мужчин, которые относятся к каннабису как к растению силы и хотят использовать его не для побега, а для честного разговора, поддержки и роста. Без лишнего пафоса и позы — просто и душевно, но по-взрослому.
            </BionicText>
          </p>
        </div>
      </section>
