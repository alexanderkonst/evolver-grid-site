...
const OnboardingProgress = ({
  ...
  return (
    <div className={cn("w-full max-w-md mx-auto mb-6", className)}>
      <div className={cn("flex justify-between text-sm mb-2 text-[#2c3150]/60", labelClassName)}>
        <span>Step {current} of {total}</span>
      </div>
      <div className={cn("h-2 bg-[#a4a3d0]/20 rounded-full overflow-hidden", trackClassName)}>
        <div
          className={cn(
