        ...
        <div className="min-h-dvh flex flex-col items-center justify-center px-6 py-12 bg-gradient-to-b from-white to-[var(--wabi-pearl)]">
            <div className="max-w-lg mx-auto text-center space-y-8">
                ...
                <div className="space-y-3 pt-4">
                    <Button
                        size="lg"
                        className="w-full max-w-sm h-14 text-lg font-semibold rounded-xl bg-gradient-to-r from-[var(--wabi-sage)] to-[var(--wabi-aqua)] text-[var(--wabi-text-primary)] hover:opacity-90 transition-all duration-200 shadow-lg hover:shadow-xl"
                        onClick={onStart}
                        disabled={saving}
                    >
                        Map My Life
