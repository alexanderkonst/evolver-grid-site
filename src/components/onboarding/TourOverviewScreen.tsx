        ...
        <div className="min-h-dvh flex flex-col items-center justify-center px-6 py-12 bg-gradient-to-b from-white to-[var(--wabi-pearl)]">
            <div className="max-w-lg mx-auto text-center space-y-8">
                ...
                <div className="space-y-3 pt-4">
                    <Button
                        size="lg"
                        className="w-full max-w-sm h-14 text-base font-semibold rounded-xl bg-gradient-to-r from-[var(--wabi-lilac)] to-[var(--wabi-orchid)] text-[var(--wabi-text-primary)] hover:opacity-90 hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 shadow-lg hover:shadow-xl"
                        onClick={onStartTour}
                        disabled={saving}
                    >
                        Show Me Around
