import { ArrowLeft, ArrowRight, User, Zap, Compass, Building2, Store, Lock, Eye, CheckCircle2 } from "lucide-react";
...
const TOUR_STEPS: TourStep[] = [
    {
        ...
        title: "Profile",
        tagline: "This is YOU",
        description: "Your Zone of Genius lives here. Map your resources, discover your mission, and track your growth.",
        status: "unlocked",
    },
    {
        id: "transformation",
    ...
    },
    {
        ...
        title: "Discover",
        tagline: "This is where you CONNECT",
        description: "Find your tribe through genius matchmaking. Share your resources and mission to find your people.",
        status: "locked",
        unlockAction: "Map Resources + Discover Mission",
    },
    {
        id: "incubator",
        icon: Building2,
        ...
        tagline: "This is where you BUILD",
        description: "Create your first Genius Product and launch your offer to the world.",
        status: "locked",
        unlockAction: "Reveal Genius Business",
    },
    {
        id: "marketplace",
        icon: Store,
        ...
        title: "Marketplace",
        tagline: "Share your gifts",
        description: "Offer your unique genius to the world. This is where transformation becomes transaction.",
        status: "view-only",
        unlockAction: "Create your first Genius Offer",
    },
];
